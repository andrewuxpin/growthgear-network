...
<Callout variant="warning" title="Configure Conversions During Setup, Not Later">
Many teams set up GA4 with default settings and plan to configure conversions later. By the time they do, they have lost weeks or months of baseline data. Define your key conversion events on day one.
</Callout>

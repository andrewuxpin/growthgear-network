...
tags:
  ...
  - step-by-step
keyTakeaways:
  - "GA4 uses an event-based data model instead of sessions, providing more flexible tracking"
  - "Over 85% of websites now use GA4 -- mastering it is non-negotiable for marketers"
  - "Enhanced measurement automatically tracks scrolls, outbound clicks, and file downloads"
  - "Set up conversion events and custom dimensions during initial configuration, not as an afterthought"
callout:
  variant: "warning"
  title: "Configure Conversions During Setup, Not Later"
  content: "Many teams set up GA4 with default settings and plan to configure conversions later. By the time they do, they have lost weeks or months of baseline data. Define your key conversion events on day one."
---

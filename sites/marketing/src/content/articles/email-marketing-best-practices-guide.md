...
For teams scaling their entire marketing stack, combining email performance data with [marketing automation platform insights](/content-marketing/best-marketing-automation-platforms-for-growing-businesses) reveals where email fits into the broader lead nurturing journey. If you're evaluating whether to handle automation in-house or through an agency, see our [marketing automation services guide](/content-marketing/marketing-automation-services-guide) for a breakdown of the options and pricing — and [how to choose an email marketing agency](/content-marketing/how-to-choose-an-email-marketing-agency) for vendor selection specific to the email channel. If you're staffing the program internally instead, our guide on [what an email marketing manager does](/content-marketing/what-is-an-email-marketing-manager) covers the role, skills, and salary benchmarks. To understand how each best practice maps to a full inbound funnel — from subscriber acquisition to pipeline — see our guide on [how email marketing fuels your inbound strategy](/content-marketing/how-email-marketing-fuels-inbound-strategy).

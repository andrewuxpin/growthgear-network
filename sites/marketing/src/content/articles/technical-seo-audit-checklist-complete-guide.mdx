...
<Callout variant="warning" title="Fix Crawlability Issues Before Anything Else">
It is tempting to jump to content optimization or link building, but none of that matters if Googlebot cannot access your pages. Always start your audit with robots.txt, sitemap validation, and Search Console coverage reports.
</Callout>

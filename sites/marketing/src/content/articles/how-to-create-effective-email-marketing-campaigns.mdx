...
<Callout variant="tip" title="Segment Your List Before Writing a Single Email">
Sending the same email to your entire list is the fastest way to tank engagement and deliverability. Segment by purchase history, engagement level, or lifecycle stage, then tailor messaging to each group.
</Callout>

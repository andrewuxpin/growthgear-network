...
<Callout variant="pro" title="Evaluate on Your Own Data, Not Public Leaderboards">
Public benchmarks are increasingly gamed by model providers. Build a private evaluation set of 50-100 examples from your actual use case and test every model against it before committing to a vendor.
</Callout>

...
- **Pre-norm [layer normalisation](/deep-learning/what-is-layer-normalization-in-deep-learning)** (LayerNorm applied before each sublayer, not after) makes training more stable at scale. The bias term is removed for efficiency.

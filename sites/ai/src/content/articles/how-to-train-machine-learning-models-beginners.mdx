...
<Callout variant="tip" title="Start Simple and Iterate">
Resist the urge to jump straight to deep learning. A well-tuned random forest or gradient boosting model often outperforms a poorly configured neural network, trains in seconds instead of hours, and is far easier to debug.
</Callout>

...
Synthetic data isn't the only architecture for training on sensitive information without exposing it. Our comparison of [federated learning vs centralized machine learning](/deep-learning/federated-learning-vs-centralized-machine-learning-guide) covers the alternative approach: instead of generating artificial stand-in data, the model trains directly on the real data at its source and only aggregated updates leave the building.

...
<Callout variant="warning" title="Removing Race and Gender Fields Is Not Enough">
Simply removing explicit protected attributes from training data gives a false sense of security. ZIP codes, school names, and employment history can all serve as proxy variables that encode the same biases. You need fairness-aware algorithms and continuous monitoring.
</Callout>

...
The most common excuse for generic outreach is "we don't have time to personalize." That's a false choice. The model that works is 30% custom, 70% templated. Cold outreach is just one component of a broader daily selling system — for the full picture of how top reps allocate time across prospecting, pipeline management, and performance tracking, see [salesperson strategies to hit quota consistently](/sales-techniques/salesperson-strategies-hit-quota-consistently). For a complete multi-channel prospecting system that ties cold email to LinkedIn, phone, and referral outreach, see the [sales prospecting techniques guide](/sales-techniques/sales-prospecting-techniques).
